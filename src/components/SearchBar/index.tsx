...
const SearchBar = () => {
  ...
  // markalar dizisindeki elemanları react-select'in istediği veri formatına getiriyoruz her render sırasında gereksiz tekrar hesaplamayı önlemek içinde useMemo kullandık
  ...
  // form gönderilnce seçilen marka ve modeli url'e param olarak ekle
